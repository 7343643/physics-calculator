...
class help():
    def __init__(self):
        ...
        def back_but():
            ...
            bak = True
            root.destroy()
        #this makes the frame that will hold everything 
        self.help_frame = Frame(padx=10, pady=10)
        self.help_frame.grid()
        self.help_frame.rowconfigure((0,1),weight=1)
        self.help_frame.columnconfigure((0,1),weight=1)
        ...
        "also to do division you need to use / for example 1/2 = 0.5"
