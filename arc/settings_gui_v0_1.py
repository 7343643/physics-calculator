...
class settings():
    ...
    def __init__(self):
        ...
        button_detail_list = [
            ["show uncertainties in history", 0, lambda:clrchg(0), 0],
            ["show calculations in history", 0, lambda:clrchg(1), 1],
            ["Round to correct number of significant figures", 1, lambda:clrchg(2), 2],
            ["colorblind mode", 1, lambda:clrchg(3), 3]
        ]
